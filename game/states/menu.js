...
Menu.prototype = {
  ...
  create: function() {
    ...
    this.scoreText = this.game.add.bitmapText(0, 300, 'minecraftia','PLAY', 42);
    ...
    this.instructionsText = this.game.add.bitmapText(270, 365, 'minecraftia', 'Use Up/Down Arrows to move', 16);
